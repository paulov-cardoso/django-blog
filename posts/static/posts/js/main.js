/**
 * main.js
 * Entry point da aplicação frontend — versão final após Etapa 6.
 *
 * Todos os módulos estão extraídos. Os templates não contêm mais
 * lógica de negócio — apenas estrutura HTML e onclick="" mínimos
 * que delegam para funções registradas aqui no window.
 */
...
// ── Registrar globais (antes do DOMContentLoaded) ─────────────────────────────
// Funções chamadas via onclick="" precisam estar no window imediatamente.
